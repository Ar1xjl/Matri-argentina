...
export const ABOUT_PAGES = [
  ...
  { id: 'tratamientos',     icon: '📦', label: 'Ciclo de un Tratamiento',            group: 'Flujos críticos', customerVisible: true },
  { id: 'precios',          icon: '💲', label: 'Manejo de precios',                  group: 'Flujos críticos', customerVisible: false },
  { id: 'matrisure',        icon: '📸', label: 'MatriSure',                          group: 'Operación y calidad', customerVisible: true },
  { id: 'firmeza',          icon: '📊', label: 'Evaluación de Firmeza',              group: 'Operación y calidad', customerVisible: true },
  { id: 'generadores',      icon: '⚡', label: 'Generadores',                        group: 'Operación y calidad', customerVisible: true },
  ...
  { id: 'glosario',         icon: '📚', label: 'Glosario',                          group: 'Referencia', customerVisible: true },
]
